...
//     try {
//       const createUser = await axios.post("/User/CreateUser", userData);
//       if (
//         createUser.status === 200 &&
//         createUser.data.isSucceed &&
//         createUser.data.message === "Create User successfully"
//       ) {
...
//     try {
//       const deleteUser = await axios.delete(`/User/DeleteUser/${userId}`);
//       if (
//         deleteUser.status === 200 &&
//         deleteUser.data.isSucceed &&
//         deleteUser.data.message === "Delete User successfully"
//       ) {
...
//         visible={isModalOpen}
//         onOk={data ? handleUpdateUserData : handleCreateUserData}
//         onCancel={handleCancel}
//       >
//         <Form
//           name="trigger"
...
//           {data ? null : ( // Hide password field for create operation
//             <Form.Item label="Password">
//               <Input
//                 value={userData?.password}
//                 onChange={handleChangeInput}
